			...
			<div className="z-30 basis-2/5 mt-12 md:mt-32">
				...
				>
					<p className="text-4xl font-playfair z-10 text-center md:text-start">
						Mursalin {""}
						<span
							className="text-5xl xs:relative xs:text-deep-blue xs:font-semibold z-20 
					...
					<p className="mt-10 mb-7 text-sm text-center md:text-start">
						Web Developer Tech Enthusiast Vivid Learner Web Developer Tech Enthusiast Vivid Learner
				...
				>
					...
					>
						...
						flex justify-center items-center font-playfair px-10">
							Let's talk
						</div>
					</AnchorLink>
				</motion.div>
